...
if(isset($_POST['send'])){
   ...
   if($select_message->rowCount() > 0){
      $message[] = 'Anda sudah mengajukan komplain';
   }else{

      $insert_message = $conn->prepare("INSERT INTO `messages`(user_id, name, email, number, message) VALUES(?,?,?,?,?)");
      $insert_message->execute([$user_id, $name, $email, $number, $msg]);

      $message[] = 'Komplain berhasil terkirim!';
...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <textarea name="msg" class="box" placeholder="Apa keluhan Anda?" cols="30" rows="10"></textarea>
      <input type="submit" value="Kirim Pesan" name="send" class="btn">
   </form>

</section>

<section class="view-complaints">
   <h3>Lihat Komplain</h3>
   <p>Anda dapat melihat komplain yang telah Anda kirimkan sebelumnya.</p>
   <a href="view_complaints.php" class="btn">Lihat Komplain</a>
</section>
